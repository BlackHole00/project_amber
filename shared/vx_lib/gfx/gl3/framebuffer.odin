...
Gl3Framebuffer :: ^Framebuffer_Impl

framebuffer_new :: proc(desc: gfx.Framebuffer_Descriptor) -> Gl3Framebuffer {
...
framebuffer_new_from_textures :: proc(framebuffer_size: [2]uint, color_attachment: Maybe(Gl3Texture), depth_attachment: Maybe(Gl3Texture)) -> Gl3Framebuffer {
    framebuffer := new(Framebuffer_Impl, CONTEXT.gl_allocator)
...
framebuffer_free :: proc(framebuffer: Gl3Framebuffer) {
...
framebuffer_resize :: proc(framebuffer: Gl3Framebuffer, size: [2]uint) {
...
@(private)
framebuffer_bind :: proc(framebuffer: Gl3Framebuffer) {
...
@(private)
finalize_framebuffer :: proc(framebuffer: Gl3Framebuffer) {
    framebuffer_bind(framebuffer)

    if framebuffer.use_depth_stencil_attachment {
        gl.FramebufferTexture(gl.FRAMEBUFFER, gl.DEPTH_STENCIL_ATTACHMENT, framebuffer.depth_stencil_attachment.texture_handle, 0)
    }
    if framebuffer.use_color_attachment {
        gl.FramebufferTexture(gl.FRAMEBUFFER, gl.COLOR_ATTACHMENT0, framebuffer.color_attachment.texture_handle, 0)
    }
}

@(private)
framebuffer_bind_color_attachment_to_readbuffer :: proc(framebuffer: Gl3Framebuffer) {
    framebuffer_bind(framebuffer)
