...
texture_set_data_1d :: proc(texture: Gl3Texture, data: rawptr, data_size: uint, offset := 0) {
    ...
    when MODERN_OPENGL do gl.TextureSubImage1D(texture.texture_handle, 0, (i32)(offset), (i32)(data_size), (u32)(textureformat_to_glformat(texture.format)), (u32)(pixeltype_to_glenum(texture.pixel_type)), data)
    else {
...
texture_set_data_2d :: proc(texture: Gl3Texture, data: rawptr, data_size: uint, dimension: [2]uint, offset := [2]uint{ 0, 0 }) {
    ...
    when MODERN_OPENGL do gl.TextureSubImage2D(texture.texture_handle, 0, (i32)(offset.x), (i32)(offset.y), (i32)(dimension.x), (i32)(dimension.y), (u32)(textureformat_to_glformat(texture.format)), (u32)(pixeltype_to_glenum(texture.pixel_type)), data)
    else {
        texture_non_dsa_bind(texture)
...
texture_set_data_3d :: proc(texture: Gl3Texture, data: rawptr, data_size: uint, dimension: [3]uint, offset := [3]uint{ 0, 0, 0 }) {
    ...
    when MODERN_OPENGL do gl.TextureSubImage3D(texture.texture_handle, 0, (i32)(offset.x), (i32)(offset.y), (i32)(offset.z), (i32)(dimension.x), (i32)(dimension.y), (i32)(dimension.z), (u32)(textureformat_to_glformat(texture.format)), (u32)(pixeltype_to_glenum(texture.pixel_type)), data)
    else {
        texture_non_dsa_bind(texture)
...
texture_copy_1d :: proc(src: Gl3Texture, dest: Gl3Texture, src_offset: int = 0, dest_offset: int = 0) {
    ...
    when MODERN_OPENGL do gl.CopyImageSubData(src.texture_handle, texturetype_to_glenum(src.type), 0, (i32)(src_offset), 0, 0, dest.texture_handle, texturetype_to_glenum(dest.type), 0, (i32)(dest_offset), 0, 0, (i32)(size), 1, 1)
    else {
...
texture_copy_2d :: proc(src: Gl3Texture, dest: Gl3Texture, src_offset: [2]int = { 0, 0 }, dest_offset: [2]int = { 0, 0 }) {
    ...
    when MODERN_OPENGL do gl.CopyImageSubData(src.texture_handle, texturetype_to_glenum(src.type), 0, (i32)(src_offset.x), (i32)(src_offset.y), 0, dest.texture_handle, texturetype_to_glenum(dest.type), 0, (i32)(dest_offset.x), (i32)(dest_offset.y), 0, (i32)(size.x), (i32)(size.y), 1)
    else {
        real_src_offset := -src_offset
        real_dest_offset := -dest_offset
...
texture_copy_3d :: proc(src: Gl3Texture, dest: Gl3Texture, src_offset: [3]int = { 0, 0, 0 }, dest_offset: [3]int = { 0, 0, 0 }) {
    ...
    when MODERN_OPENGL do gl.CopyImageSubData(src.texture_handle, texturetype_to_glenum(src.type), 0, (i32)(src_offset.x), (i32)(src_offset.y), (i32)(src_offset.z), dest.texture_handle, texturetype_to_glenum(dest.type), 0, (i32)(dest_offset.x), (i32)(dest_offset.y), (i32)(dest_offset.z), (i32)(size.x), (i32)(size.y), (i32)(size.z))
    else {
        real_src_offset := -src_offset
        real_dest_offset := -dest_offset
